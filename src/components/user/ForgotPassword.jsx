...
function ForgotPassword() {
  ...
  return (
    ...
    <h1 className="mt-5" style={{color:"#ce5cbf",fontStyle:'italic','fontWeight':'bolder','textAlign':'center'}}>e-Shopping<span style={{fontSize:'15px',fontStyle:'italic',color:'#07c388a3'}}>- Let's Shop your needs</span></h1> 
